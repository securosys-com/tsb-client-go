...
var SUPPORTED_KEY_TYPES = append([]string{"EC", "ED", "RSA", "DSA", "BLS", "AES", "ChaCha20", "Camellia", "TDEA"}, POST_QUANTUM_KEY_TYPES...)
var SYMMETRIC_KEY_TYPES = []string{"AES", "Camellia", "ChaCha20", "TDEA"}
var ASYMMETRIC_KEY_TYPES = append([]string{"EC", "ED", "RSA", "DSA", "BLS"}, POST_QUANTUM_KEY_TYPES...)

var RSA_CIPHER_LIST = []string{"RSA_PADDING_OAEP_WITH_SHA512", "RSA", "RSA_PADDING_OAEP_WITH_SHA224", "RSA_PADDING_OAEP_WITH_SHA256", "RSA_PADDING_OAEP_WITH_SHA1", "RSA_PADDING_OAEP", "RSA_PADDING_OAEP_WITH_SHA384", "RSA_PADDING_PKCS", "RSA_NO_PADDING"}
...
var ML_KEM_WRAP_METHODS_LIST = []string{"ML-KEM-512", "ML-KEM-768", "ML-KEM-1024"}
...
var SUPPORTED_SIGN_KEYS = append([]string{"EC", "ED", "RSA", "DSA", "BLS"}, "ML-DSA-44", "ML-DSA-65", "ML-DSA-87", "SLH-DSA-SHA2-128s", "SLH-DSA-SHA2-128f", "SLH-DSA-SHA2-192s", "SLH-DSA-SHA2-192f", "SLH-DSA-SHA2-256s", "SLH-DSA-SHA2-256f", "SLH-DSA-SHAKE-128s", "SLH-DSA-SHAKE-128f", "SLH-DSA-SHAKE-192s", "SLH-DSA-SHAKE-192f", "SLH-DSA-SHAKE-256s", "SLH-DSA-SHAKE-256f", "LMS", "XMSS-SHA256_10_256", "XMSS-SHAKE256_10_256")
...
var EC_SIGNATURE_LIST = []string{"NONE_WITH_ECDSA", "SHA1_WITH_ECDSA", "SHA224_WITH_ECDSA", "SHA256_WITH_ECDSA", "DOUBLE_SHA256_WITH_ECDSA", "SHA384_WITH_ECDSA", "SHA512_WITH_ECDSA", "SHA3224_WITH_ECDSA", "SHA3256_WITH_ECDSA", "SHA3384_WITH_ECDSA", "SHA3512_WITH_ECDSA", "SHA256_WITH_ECDSA_DETERMINISTIC", "KECCAK224_WITH_ECDSA", "KECCAK256_WITH_ECDSA", "KECCAK384_WITH_ECDSA", "KECCAK512_WITH_ECDSA"}
